...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private AccountDirectory acctDirectory;
    
    public MainJFrame() {
        initComponents();
        this.acctDirectory = new AccountDirectory();
        generateDemoData(acctDirectory);
    }
    
    private static void generateDemoData(AccountDirectory accountDirectory) {
    ...
    private void initComponents() {
        ...
        topJPanelLayout.setHorizontalGroup(
            ...
            .addGroup(topJPanelLayout.createSequentialGroup()
                .addGap(53, 53, 53)
                .addComponent(btnAccountMng, javax.swing.GroupLayout.PREFERRED_SIZE, 265, javax.swing.GroupLayout.PREFERRED_SIZE)
